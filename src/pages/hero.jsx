...
const Hero = () => {
  return (
    <div className='max-w-[1640px] mx-auto p-4'>
      ...
      {/* Book Card */}
      <div className="w-full max-w-sm bg-black border border-white-200 rounded-lg shadow dark:bg-gray-400 dark:border-gray-300">
        <a href="#">
          <img className="p-8 rounded-t-xl" src="https://marketplace.canva.com/EAD7WmQzMUQ/2/0/1003w/canva-moon-photo-thriller-mystery-book-cover-QE7uv7YSwDQ.jpg" alt="product image" />
        </a>
